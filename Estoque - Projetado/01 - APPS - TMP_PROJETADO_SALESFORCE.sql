...
create index APPS.IDX_SALESFORCE_PRJCD_01 on APPS.OM_SALDO_PRODUTO_ATP_JB_CD_V2(NVL("VOL_META",0),"COD_ITEM","ID_PERIODO");

GRANT ALTER, DELETE, INDEX, INSERT, SELECT, UPDATE, DEBUG, FLASHBACK ON APPS.TMP_PROJETADO_SALESFORCE TO APPSR;

GRANT ALTER, DELETE, INDEX, INSERT, SELECT, UPDATE, DEBUG, FLASHBACK ON APPS.TMP_PROJETADO_SALESFORCE TO XXPB;
